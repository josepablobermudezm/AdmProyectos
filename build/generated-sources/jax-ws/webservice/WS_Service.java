 ...
 * 
 */
@WebServiceClient(name = "WS", targetNamespace = "http://webService/", wsdlLocation = "http://localhost:8989/WebServiceTarea2/WS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8989/WebServiceTarea2/WS?wsdl");
